...
const Navbar = () =>{
    ...
    return(
        <div className="Navbar w-screen fixed top-0 left-0 px-5 sm:px-10 md:px-20 py-4 z-10 bg-mild flex justify-between items-center">
            ...
            <ul className="text-offmode items-center gap-3 sm:gap-4 md:gap-5 lg:gap-8 justify-between text-md font-semibold hidden md:flex">
                ...
                {
                    myprofile.dailyLog?<div className="px-3 py-2 text-white bg-primary rounded-md flex items-center justify-center gap-5 font-bold">
                        Credits : {myprofile.dailyLog.creditsCount}
                    </div>:<div className="px-3 py-2 text-white bg-primary rounded-md flex items-center justify-center gap-5 font-bold">
                        For Premium
                    </div>
                }
            </ul>
            <button onClick={()=>setOpen((prev)=>!prev)} className="block md:hidden"><FaBars size={20}/></button>
            {
                ...
                <ul className="absolute flex flex-col top-16 right-5 w-64 z-50 rounded-md bg-mild md:hidden">
                    ...
                    <Link className="opacity-65 hover:opacity-100 cursor-pointer bg-offmode hover:bg-primary text-white px-5 py-4" to='/'>Search</Link>
                    <Link className="opacity-65 hover:opacity-100 cursor-pointer bg-offmode hover:bg-primary text-white px-5 py-4" to=''>Matches</Link>
                    <Link className="opacity-65 hover:opacity-100 cursor-pointer bg-offmode hover:bg-primary text-white px-5 py-4" to=''>Liked</Link>
